...
public final class IssuesAppDelegate: NSObject, NSApplicationDelegate {
...
/// The full SwiftUI `Scene` graph for Issues.app. The Xcode-side
/// `Issues/IssuesApp.swift` is a 5-line `@main` shim that instantiates
/// this scene — every window, every command builder, every Sparkle
/// hook lives here so it can be unit-tested and edited without
/// touching the Xcode project.
public struct IssuesRootScene: Scene {
    ...
    @NSApplicationDelegateAdaptor(IssuesAppDelegate.self) private var appDelegate
