...
public nonisolated enum MarkdownIssueParser {
    ...
    public static func body(from contents: String) -> String {
    ...
    public static func filenameMatchesIssuePattern(_ filename: String) -> Bool {
        let range = NSRange(filename.startIndex..<filename.endIndex, in: filename)
        return filenamePattern.firstMatch(in: filename, range: range) != nil
    }

    public static func parse(fileURL: URL) throws -> Issue? {
    ...
    public static func attachmentFolderHasFiles(for issueFileURL: URL) -> Bool {
