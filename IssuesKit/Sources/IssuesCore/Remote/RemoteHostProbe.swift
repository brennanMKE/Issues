...
public protocol RemoteHostProbe: AnyObject, Sendable {
...
public enum RemoteHostProbeError: Error, Equatable, Sendable {
...
public final class URLSessionRemoteHostProbe: RemoteHostProbe, @unchecked Sendable {
    ...
    public func fetchHost(host: String, port: UInt16, token: String?) async throws -> HostInfo {
    ...
    public func fetchFolders(host: String, port: UInt16, token: String) async throws -> [FolderInfo] {
    ...
    public static func url(host: String, port: UInt16, path: String) -> URL? {
