...
public nonisolated struct TokenRecord: Codable, Equatable, Sendable {
...
public enum AccessToken {
    ...
    public nonisolated static let defaultService = "co.sstools.Issues.RemoteAccess.HostTokens"
    ...
    public static let plaintextLength = 47
    ...
    public static func parseCombined(_ raw: String) throws -> (plaintext: String, fingerprint: String) {
    ...
    public static func revoke(hash: Data, service: String = defaultService) throws {
        var db = try load(service: service)
    ...
    public static func list(service: String = defaultService) throws -> [TokenRecord] {
    ...
    public nonisolated static func touch(
        hash: Data,
        from peer: String?,
        service: String = defaultService
    ) throws {
