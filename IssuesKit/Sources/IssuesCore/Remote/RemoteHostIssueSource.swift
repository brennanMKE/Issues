...
public enum RemoteIssueSourceEvent: Sendable, Equatable {
    case reloaded
...
@MainActor
public final class RemoteHostIssueSource: IssueSource {
    ...
    public static let urlScheme = "issues-remote"

    // MARK: - IssueSource conformance (observable state)

    public nonisolated var folderURL: URL { syntheticFolderURL }
    ...
    /// readable.
    public var repoName: String { displayName }
    ...
    public private(set) var connectionState: RemoteConnectionState = .connected
    ...
    public let eventStream: AsyncStream<RemoteIssueSourceEvent>
    ...
    public func fetchBody(for id: String) async throws -> String {
    ...
    public func hasCachedBody(for id: String) -> Bool {
        bodyCache[id] != nil
    }
    ...
    public func fetchAttachmentData(issueId: String, name: String) async throws -> Data {
