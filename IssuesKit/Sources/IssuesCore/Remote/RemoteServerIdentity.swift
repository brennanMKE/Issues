...
public enum RemoteServerIdentityError: Error, Equatable {
...
public enum DERTag {
    ...
    public static let contextSpecific0: UInt8 = 0xA0
    /// Context-specific, constructed, tag 3 ([3]).
    public static let contextSpecific3: UInt8 = 0xA3
}

public enum DER {

    /// Encode an ASN.1 length octet block (definite form).
    public static func length(_ count: Int) -> Data {
        if count < 0x80 {
    ...
    public static func wrap(tag: UInt8, _ content: Data) -> Data {
        var out = Data([tag])
    ...
    public static func integer(_ bytes: Data) -> Data {
        var trimmed = bytes
    ...
    public static func bitString(_ payload: Data, unusedBits: UInt8 = 0) -> Data {
        var data = Data([unusedBits])
        data.append(payload)
        return wrap(tag: DERTag.bitString, data)
    }

    public static func octetString(_ payload: Data) -> Data {
    ...
    public static func printableString(_ value: String) -> Data {
    ...
    public static func explicitTag(_ tag: UInt8, _ content: Data) -> Data {
...
public enum X509Builder {
    ...
    public static func ecdsaSHA256AlgorithmIdentifier() -> Data {
        DER.sequence([
    ...
    public static func ecP256AlgorithmIdentifier() -> Data {
        DER.sequence([
    ...
    public static func name(commonName: String) -> Data {
    ...
    public static func subjectPublicKeyInfo(publicKeyBitString: Data) -> Data {
        DER.sequence([
    ...
    public static func tbsCertificate(
        serial: Data,
    ...
    /// ECDSA-DER signature.
    public static func wrapCertificate(tbs: Data, signature: Data) -> Data {
        DER.sequence([
            tbs,
