...
public enum WebSocketHandshake {
    ...
    public static func acceptValue(forKey clientKey: String) -> String {
    ...
    public static func isUpgradeRequest(headers: [String: String]) -> Bool {
    ...
    public static func header(_ headers: [String: String], _ name: String) -> String? {
    ...
    public static func upgradeResponse(clientKey: String) -> Data {
...
public struct WebSocketFrame: Equatable {
    ...
    public init(fin: Bool, opcode: Opcode, payload: Data) {
        self.fin = fin
        self.opcode = opcode
...
public enum WebSocketFraming {
    ...
    public static let maxPayloadSize: Int = 1 << 20

    public static func decodeClientFrame(from data: Data) throws -> (frame: WebSocketFrame, consumed: Int) {
    ...
    public static func encodeServerFrame(_ frame: WebSocketFrame) -> Data {
        var out = Data()
    ...
    public static func encodeClose(code: WebSocketCloseCode, reason: String = "") -> Data {
        var payload = Data()
    ...
    public static func encodePong(payload: Data = Data()) -> Data {
...
public final class WebSocketSession {
    ...
    public private(set) var subscribedFolderIds: Set<String> = []
    ...
    public private(set) var peer: PeerInfo
    ...
    /// actor.
    public var onSubscribe: ((WebSocketSession, [String]) -> Void)?
    public var onUnsubscribe: ((WebSocketSession, [String]) -> Void)?
    ...
    public func dropSubscription(folderId: String, reason: String) {
    ...
    public func updatePeer(tokenName: String?) {
    ...
    public func _applyCommandForTest(_ command: RemoteCommand) {
        switch command.type {
        case .subscribe:
            let ids = command.folderIds ?? []
            subscribedFolderIds.formUnion(ids)
    ...
    public var _testRecorder: ((RemoteEvent) -> Void)?
}
