...
public struct RemoteHostIdentity: Codable, Hashable, Identifiable, Sendable {
    ...
    public init(host: String, port: UInt16, displayName: String?, lastUsedAt: Date) {
        self.host = host
        self.port = port
...
public enum RemoteHostRecents {

    public static let defaultsKey = "RemoteHost.recents"
    ...
    public static func list(defaults: UserDefaults = .standard) -> [RemoteHostIdentity] {
    ...
    @discardableResult
    public static func upsert(_ identity: RemoteHostIdentity, defaults: UserDefaults = .standard) -> [RemoteHostIdentity] {
    ...
    @discardableResult
    public static func forget(id: String, defaults: UserDefaults = .standard) -> [RemoteHostIdentity] {
        var current = list(defaults: defaults)
    ...
    public static func deleteAll(defaults: UserDefaults = .standard) {
