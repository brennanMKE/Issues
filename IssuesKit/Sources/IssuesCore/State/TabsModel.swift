...
public final class TabsModel {
    ...
    public private(set) var tabs: [IssueStore] = []
    ...
    public private(set) var hasUnseenChanges: [UUID: Bool] = [:]
    ...
    public var activeTab: IssueStore? {
    ...
    @discardableResult
    public func openTab(url: URL) -> IssueStore {
    ...
    @discardableResult
    public func openRemoteTab(host: String, port: UInt16, token: String, folderId: String, fingerprint: String = "", displayName: String? = nil) -> IssueStore {
    ...
    @discardableResult
    public func openOrActivate(folderPath: String, bookmarks: FolderBookmarkService) -> OpenOrActivateOutcome {
    ...
    public enum OpenOrActivateOutcome {
    ...
    public func reorderWithoutPersisting(from source: Int, to destination: Int) {
    ...
    public func saveTabStateIfChanged(_ store: IssueStore) {
