...
@Observable
public final class IssueStore: Identifiable {
    ...
    public enum SortColumn: String, Hashable {
    ...
    public enum AttachmentFilter: String, CaseIterable, Hashable, Sendable {
    ...
    public var statusFilters: Set<IssueStatus> = []
    public var moduleFilter: String?
    public var platformFilter: String?
    public var attachmentFilter: AttachmentFilter = .all
    public var searchQuery: String = ""
    public var viewMode: ViewMode = .swimlane
    public var selectedIssueID: String?
    public var sortColumn: SortColumn = .id
    ...
    public var pendingReveal: Issue?
    ...
    public var onReload: ((IssueStore) -> Void)?
    ...
    public var onReloadBroadcast: ((IssueStore) -> Void)?
    ...
    public var folderURL: URL { source.folderURL }
    ...
    public var repoName: String { source.repoName }
    ...
    public var projectMetadata: ProjectMetadata? { source.projectMetadata }
    ...
    public var bookmarkData: Data? { source.bookmarkData }
    ...
    public var remoteEndpoint: (host: String, port: UInt16)? {
    ...
    public var remoteConnectionState: RemoteConnectionState? {
    ...
    public convenience init(folderURL: URL, bookmarkData: Data? = nil) {
        self.init(source: LocalFolderIssueSource(folderURL: folderURL, bookmarkData: bookmarkData))
    }

    public init(source: any IssueSource) {
        self.source = source
    ...
    public var filteredIssues: [Issue] {
    ...
    public func groupedByPrimaryModule(_ list: [Issue]) -> [(module: String, issues: [Issue])] {
        var order: [String] = []
    ...
    public var uniqueModules: [String] {
        var set = Set<String>()
        for issue in issues {
    ...
    public var uniquePlatforms: [String] {
        var set = Set<String>()
    ...
    /// saw on this tab.
    public var snapshot: [String: IssueSnapshot] {
    ...
    public var statusCounts: [IssueStatus: Int] {
    ...
    public func issueIsCurrentlyVisible(id: String) -> Bool {
    ...
    public func revealIssue(_ issue: Issue) {
        viewMode = .list
    ...
    public var visibleIssueOrder: [Issue] {
    ...
    public func persistedState() -> TabPersistedState {
        TabPersistedState(
    ...
    /// against.
    public func apply(_ state: TabPersistedState) {
