...
@Observable
@MainActor
public final class RemoteHostController {
    ...
    public private(set) var isUserEnabled: Bool = false
    ...
    public private(set) var interfaces: [NetworkInterfaceLister.InterfaceAddress] = []
    ...
    public let folderStore: HostFolderStore
    ...
    public private(set) var identity: RemoteServerIdentity?
    ...
    public func generateToken(name: String, expiresAt: Date?) throws -> AccessToken.Generated {
    ...
    @discardableResult
    public func rotateCertificate() throws -> RemoteServerIdentity {
    ...
    public enum RemoteHostControllerError: Error, Equatable {
        case noIdentity
    }
    ...
    public init(folderStore: HostFolderStore? = nil) {
    ...
    public func reEnableOnCurrentNetwork() {
        allowlistCurrentNetwork()
        do {
            try start()
        } catch {
    ...
    public func setStores(_ stores: [IssueStore]) {
    ...
    public func setFolderShared(folderId: String, _ isShared: Bool) {
