...
@Observable
@MainActor
public final class HostFolderStore: MultiFolderStore {
    ...
    public private(set) var stores: [IssueStore] = []
    ...
    public var isGlobalHostingEnabled: Bool = false
    ...
    public var defaultIsSharedForNewFolders: Bool = false
    ...
    public func currentlyHostedFolders() -> [HostedFolder] {
        guard isGlobalHostingEnabled else { return [] }
        return stores.compactMap { hostedFolder(from: $0, applyingShareFilter: true) }
    }

    public func currentlyHostedFolder(forId id: String) -> HostedFolder? {
    ...
    public func isShared(folderId: String) -> Bool {
    ...
    public func setShared(folderId: String, _ isShared: Bool) {
    ...
    public func setSharedForAll(_ isShared: Bool) {
        for store in stores {
