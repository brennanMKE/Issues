...
final class ShortcutsStore {
    ...
    static let reservedShortcuts: [ShortcutBinding] = [
    ...
    func collisions(_ binding: ShortcutBinding, excluding: ShortcutAction?) -> [ShortcutAction] {
    ...
    static func isReserved(_ binding: ShortcutBinding) -> Bool {
