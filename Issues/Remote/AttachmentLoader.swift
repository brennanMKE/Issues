...
actor AttachmentLoader {
    ...
    func load(folderId: String, issueId: String, name: String, from source: any IssueSource) async throws -> Data {
    ...
    func preload(folderId: String, issueId: String, name: String, from source: any IssueSource) async {
    ...
    func invalidate(folderId: String, issueId: String) {
