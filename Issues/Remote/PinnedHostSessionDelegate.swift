...
final class PinnedHostSessionDelegate: NSObject, URLSessionDelegate, URLSessionTaskDelegate, @unchecked Sendable {
    ...
    static func leafCertificateFingerprint(from trust: SecTrust) -> String? {
